...
def plotLRandN(train_x, train_y):
    ...
    plt.savefig('ReportBoostBD VC 2.png')
    plt.close()
    plt.figure()
...
def plotValidationCurves(train_score, test_score, title, name, param_name, parameter_range):
    ...
    # Creating the plot
    # plt.xticks(parameter_range) For maxdepth curve
    plt.title(title)
...
def main(max_depth = 0, lr = 0, n = 0, train_x = None, test_x = None, train_y = None, test_y = None):
    ...
    #                                                         n_jobs=-1)
    #
    # plotLearningCurves(train_sizes, train_scores, test_scores, title = "Boosting Learning Curve Unpruned", name = "ReportBoostBD LC 1" )
    #
    ...
    #                                            cv=5, scoring="accuracy")
    #
    # plotValidationCurves(train_score, test_score, title="Boosting DT Depth Validation Curve", name="ReportBoostBD VC 1",
    ...
    # train_sizes, train_scores, test_scores = learning_curve(AdaBoostClassifier(random_state=42, n_estimators=50, learning_rate=1),
    #                                                         train_x, train_y, cv=5,
    #                                                         scoring='accuracy',
    #                                                         n_jobs=-1)
    #
    # plotLearningCurves(train_sizes, train_scores, test_scores, title="Boosting Learning Curve N_Estimators = 50 and Learning Rate = 1",
    #                    name="ReportBoostBD LC 2")
